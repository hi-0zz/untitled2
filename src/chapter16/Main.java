...
public class Main {
    public static void main(String[] args) {
         ...
         */
        ArrayList<Integer> level_array = new ArrayList<>();//p581
        level_array.add(1);//add 追加
        level_array.add(50);
        level_array.add(100);

        ArrayList<Pokemon> pokemon_array = new ArrayList<>();
        pokemon_array.add(pokemon1);
        pokemon_array.add(1,pokemon2);
        pokemon_array.add(2,pokemon3);
        pokemon_array.add(3,pokemon4);
        //for文
